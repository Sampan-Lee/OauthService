...
using JiYun.AuthorizationServer.Models.Repositories;
...
namespace JiYun.AuthorizationServer.Providers
{
    public class JyAuthorizationServerProvider: OAuthAuthorizationServerProvider
    {
        ...
        public ITokenInfoRepository tokenInfoRepository { get; set; }
        /// <summary>
        /// 验证
        /// </summary>
